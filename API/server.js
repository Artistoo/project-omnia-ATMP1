...
//_________________MIDDLEWARES____________________________
...
mongoose
  ...
  .catch(({message}) => console.log(`some error occured while connecting ${message}`));
...
app.get('/show', (req, res) => {
  ...
  return res.json({
    [success ? 'success' : 'fail']: `session is ${success ? `saved` : `failed`}`,
  });
});
